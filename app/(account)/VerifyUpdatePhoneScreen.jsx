...
import { updatePhone, sendMail } from "../(auth)/Auth.Api";
import AsyncStorage from "@react-native-async-storage/async-storage";

const VerifyUpdatePhoneScreen = () => {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (storedOTP === otpCode) {
        ...
        if (!phone || !accountIdString)
          throw new Error("No phone number or account ID found");
        ...
        if (res.status === 200) {
          Alert.alert("Success", "Update Phone successful!", [
            {
              text: "OK",
          ...
          Alert.alert(
            "Phone Mismatch",
            "Phone already exists, please enter your Phone!"
          );
        } else {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.verifyContainer}>
          <Text style={styles.descriptionText}>
            OTP Code has been sent to your phone. Please enter it to verify!
          </Text>
          ...
          {countdown === 0 ? (
            ...
            <Text style={styles.resendText}>
              If you email didn’t receive a message, please wait for {countdown}{" "}
...
export default VerifyUpdatePhoneScreen;
