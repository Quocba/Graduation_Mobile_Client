  ...
  const handleResendOTP = async () => {
    try {
      ...
      if (response.status === 200) {
        AsyncStorage.setItem("otp", response.data.toString());
        Alert.alert(
          "Success",
          "OTP has been verified and has been sent again, please check your email!"
        );
      } else {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.headerContainer}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={styles.verifyEmailText}>Verify OTP</Text>
        </View>
        <View style={styles.verifyContainer}>
          <Text style={styles.descriptionText}>
            OTP Code has been sent to your OTP. Please enter it to verify!
          </Text>
